 ...
 * This is the base interface for the specific implementations of a VertexQuery. Calling {@link io.openmg.kuaz.core.TitanVertex#query()}
...
public interface BaseVertexQuery<Q extends BaseVertexQuery<Q>> {
    ...
    */
     ...
     * expected to be a {@link io.openmg.kuaz.core.TitanVertex}.
     *
