...
import io.openmg.kuaz.core.schema.SchemaManager;
...
/**
 * TitanGraphTransaction defines a transactional context for a {@link io.openmg.kuaz.core.TitanGraph}. Since TitanGraph is a transactional graph
...
public interface TitanGraphTransaction extends Graph, SchemaManager {
    ...
    */
    ...
    /**
     * Returns a {@link io.openmg.kuaz.core.TitanIndexQuery} to query for vertices or edges against the specified indexing backend using
    ...
    /**
     * @return
     * @see TitanGraph#multiQuery(io.openmg.kuaz.core.TitanVertex...)
     */
    @Deprecated
