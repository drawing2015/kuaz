 ...
 * A TitanManagement transaction is opened on a graph via {@link io.openmg.kuaz.core.TitanGraph#openManagement()}.
 * <p/>
...
public interface TitanManagement extends TitanConfiguration, SchemaManager {
    ...
    /**
     * Identical to {@link #buildEdgeIndex(io.openmg.kuaz.core.EdgeLabel, String, com.tinkerpop.gremlin.structure.Direction, com.tinkerpop.gremlin.structure.Order, io.openmg.kuaz.core.PropertyKey...)}
    ...
    /**
     * Identical to {@link #buildPropertyIndex(io.openmg.kuaz.core.PropertyKey, String, com.tinkerpop.gremlin.structure.Order, io.openmg.kuaz.core.PropertyKey...)}
     ...
     * {@link io.openmg.kuaz.core.schema.SchemaAction#REINDEX} or {@link io.openmg.kuaz.core.schema.SchemaAction#REMOVE_INDEX}
     ...
     *
     * @see io.openmg.kuaz.core.TitanTransaction#commit()
     */
    public void commit();
     ...
     *
     * @see io.openmg.kuaz.core.TitanTransaction#rollback()
     */
