...
public class ManagementUtil {
     ...
     *
     * This is a utility method to be invoked between two {@link io.openmg.kuaz.core.schema.TitanManagement#updateIndex(TitanIndex, io.openmg.kuaz.core.schema.SchemaAction)} calls
