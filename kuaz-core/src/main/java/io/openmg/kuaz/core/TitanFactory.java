...
import io.openmg.kuaz.graphdb.log.StandardLogProcessorFramework;
import io.openmg.kuaz.graphdb.log.StandardTransactionLogProcessor;
...
public class TitanFactory {
     ...
     * the graph can be opened with {@link io.openmg.kuaz.core.TitanFactory.Builder#open()}.
     *
     * @return
     */
    ...
    /**
     * Returns a {@link io.openmg.kuaz.core.log.LogProcessorFramework} for processing transaction log entries
