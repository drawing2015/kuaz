...
/**
 * RelationType defines the schema for {@link TitanRelation}. RelationType can be configured through {@link io.openmg.kuaz.core.schema.RelationTypeMaker} to
 ...
 * <br />
 * RelationTypes are constructed through {@link io.openmg.kuaz.core.schema.RelationTypeMaker} which is accessed in the context of a {@link TitanTransaction}
 * via {@link io.openmg.kuaz.core.TitanTransaction#makePropertyKey(String)} for property keys or {@link io.openmg.kuaz.core.TitanTransaction#makeEdgeLabel(String)}
 ...
 * @see TitanRelation
 * @see io.openmg.kuaz.core.schema.RelationTypeMaker
