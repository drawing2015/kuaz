package io.openmg.kuaz.example;
...
import io.openmg.kuaz.core.attribute.Geoshape;
...
public class GraphOfTheGodsFactory {
     ...
     * {@link #load(io.openmg.kuaz.core.TitanGraph)} on the opened graph,
     * then calls {@link io.openmg.kuaz.core.TitanGraph#close()}
     * and returns.
     * <p/>
     ...
     * or {@link #load(io.openmg.kuaz.core.TitanGraph)}) when calling from
