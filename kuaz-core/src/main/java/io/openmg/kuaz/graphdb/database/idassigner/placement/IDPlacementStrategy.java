package io.openmg.kuaz.graphdb.database.idassigner.placement;
...
public interface IDPlacementStrategy {
    ...
    /**
     * After construction, the {@link io.openmg.kuaz.graphdb.idmanagement.IDManager} used by this graph instance
