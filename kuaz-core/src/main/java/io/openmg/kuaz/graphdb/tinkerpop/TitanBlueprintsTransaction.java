...
public abstract class TitanBlueprintsTransaction implements TitanTransaction {
     ...
     * <p/>
     * Custom id setting must be enabled via the configuration option {@link io.openmg.kuaz.graphdb.configuration.GraphDatabaseConfiguration#ALLOW_SETTING_VERTEX_ID}.
     * <p/>
     * Use {@link io.openmg.kuaz.core.util.TitanId#toVertexId(long)} to construct a valid Titan vertex id from a user id.
     *
...
//        }
        io.openmg.kuaz.graphdb.util.ElementHelper.attachProperties(vertex, keyValues);
        return vertex;
    }
