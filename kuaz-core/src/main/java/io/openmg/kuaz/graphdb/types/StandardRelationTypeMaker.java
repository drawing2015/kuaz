...
import io.openmg.kuaz.core.schema.RelationTypeMaker;
...
public abstract class StandardRelationTypeMaker implements RelationTypeMaker {
     ...
     * time interval using {@link io.openmg.kuaz.core.TitanVertexQuery#interval(io.openmg.kuaz.core.PropertyKey, Comparable, Comparable)}.
     * <br />
     ...
     * in the given order.
     * <p/>
     * {@link io.openmg.kuaz.core.RelationType}s used in the sort key must be either property out-unique keys or out-unique unidirected edge lables.
     *
    ...
    /**
     * Defines in which order to sort the relations for efficient retrieval, i.e. either increasing ({@link io.openmg.kuaz.graphdb.internal.Order#ASC}) or
     * decreasing ({@link io.openmg.kuaz.graphdb.internal.Order#DESC}).
     *
