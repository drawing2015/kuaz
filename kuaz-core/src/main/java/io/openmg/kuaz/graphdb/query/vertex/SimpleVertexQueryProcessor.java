 ...
 * in memory filtering). Under these assumptions we can remove a lot of the steps in {@link io.openmg.kuaz.graphdb.query.QueryProcessor}:
...
public class SimpleVertexQueryProcessor implements Iterable<Entry> {
    ...
    private final class LimitAdjustingIterator extends io.openmg.kuaz.graphdb.query.LimitAdjustingIterator<Entry> {
