 ...
 * {@link #execute(io.openmg.kuaz.graphdb.internal.RelationCategory, BasicVertexCentricQueryBuilder.ResultConstructor)}.
 * </p>
...
public class MultiVertexCentricQueryBuilder extends BasicVertexCentricQueryBuilder<MultiVertexCentricQueryBuilder> implements TitanMultiVertexQuery<MultiVertexCentricQueryBuilder> {
    ...
    /**
     * Constructs the BaseVertexCentricQuery through {@link BasicVertexCentricQueryBuilder#constructQuery(io.openmg.kuaz.graphdb.internal.RelationCategory)}.
     ...
     * pre-load the return result sets into the associated {@link io.openmg.kuaz.graphdb.vertices.CacheVertex} or
