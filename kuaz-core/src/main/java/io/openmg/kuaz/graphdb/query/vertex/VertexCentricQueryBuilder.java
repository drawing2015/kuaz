 ...
 * {@link #constructQuery(io.openmg.kuaz.graphdb.internal.RelationCategory)}. However, there is
 * one important special case: If the constructed query is simple (i.e. {@link io.openmg.kuaz.graphdb.query.vertex.VertexCentricQuery#isSimple()=true}
 ...
 * {@link io.openmg.kuaz.graphdb.database.IndexSerializer}) via {@link #queryOnlyLoaded()}.
 * </p>
