...
import io.openmg.kuaz.core.BaseVertexQuery;
...
import io.openmg.kuaz.graphdb.query.Query;
import io.openmg.kuaz.graphdb.query.TitanPredicate;
import io.openmg.kuaz.graphdb.query.condition.PredicateCondition;
import io.openmg.kuaz.graphdb.relations.RelationIdentifier;
import io.openmg.kuaz.graphdb.tinkerpop.ElementUtils;
...
/**
 * Builds a {@link io.openmg.kuaz.core.BaseVertexQuery}, optimizes the query and compiles the result into a {@link BaseVertexCentricQuery} which
...
public abstract class BaseVertexCentricQueryBuilder<Q extends BaseVertexQuery<Q>> implements BaseVertexQuery<Q> {
    ...
    /**
     * Whether this query is asking for the value of an {@link io.openmg.kuaz.graphdb.types.system.ImplicitKey}.
     * </p>
