...
import io.openmg.kuaz.graphdb.types.system.ImplicitKey;
import io.openmg.kuaz.graphdb.types.system.SystemRelationType;
import org.apache.tinkerpop.gremlin.structure.Direction;
import io.openmg.kuaz.util.datastructures.Interval;
import io.openmg.kuaz.util.datastructures.PointInterval;
import io.openmg.kuaz.util.datastructures.RangeInterval;
...
/**
 * Builds a {@link BaseVertexQuery}, optimizes the query and compiles the result into a {@link io.openmg.kuaz.graphdb.query.vertex.BaseVertexCentricQuery} which
...
public abstract class BasicVertexCentricQueryBuilder<Q extends BaseVertexQuery<Q>> extends BaseVertexCentricQueryBuilder<Q> {
     ...
     * vertex object only. This is used in combination with {@link io.openmg.kuaz.graphdb.vertices.PreloadedVertex}, for example.
     */
    ...
    /**
     * If {@link #isImplicitKeyQuery(io.openmg.kuaz.graphdb.internal.RelationCategory)} is true,
     ...
     * logic is taken from {@link #constructQuery(io.openmg.kuaz.graphdb.internal.RelationCategory)}
     ...
     * @param baseQuery as constructed by {@link #constructQuery(io.openmg.kuaz.graphdb.internal.RelationCategory)}
     * @return
     */
     ...
     * to adjust the limit too often in {@link io.openmg.kuaz.graphdb.query.LimitAdjustingIterator}.
     *
