...
import io.openmg.kuaz.graphdb.query.condition.FixedCondition;
 ...
 * base vertex of the query. This query is constructed by {@link BasicVertexCentricQueryBuilder#constructQuery(io.openmg.kuaz.graphdb.internal.RelationCategory)}
 * and then later extended by single or multi-vertex query which add the vertex to the query.
 * </p>
 * This class override many methods in {@link io.openmg.kuaz.graphdb.query.ElementQuery} - check there
 * for a description.
 *
