...
import io.openmg.kuaz.core.TitanVertexQuery;
import io.openmg.kuaz.core.schema.SchemaStatus;
import io.openmg.kuaz.graphdb.internal.TitanSchemaCategory;
import io.openmg.kuaz.graphdb.transaction.RelationConstructor;
import io.openmg.kuaz.graphdb.transaction.StandardTitanTx;
import io.openmg.kuaz.graphdb.types.*;
import io.openmg.kuaz.graphdb.types.indextype.CompositeIndexTypeWrapper;
import io.openmg.kuaz.graphdb.types.indextype.MixedIndexTypeWrapper;
...
public class TitanSchemaVertex extends CacheVertex implements SchemaSource {
     ...
     * This is needed when the type gets modified in the {@link io.openmg.kuaz.graphdb.database.management.ManagementSystem}.
     */
