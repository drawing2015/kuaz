...
public interface OrderedKeyValueStore extends KeyValueStore {
    ...
    /**
     * Like {@link #getSlice(KVQuery, io.openmg.kuaz.storage.keycolumnvalue.StoreTransaction)} but executes
     ...
     * {@link io.openmg.kuaz.storage.keycolumnvalue.StoreFeatures#hasMultiQuery()} return true. Otherwise
