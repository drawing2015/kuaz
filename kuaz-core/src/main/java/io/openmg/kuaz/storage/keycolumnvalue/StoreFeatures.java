...
public interface StoreFeatures {
     ...
     * {@link KeyColumnValueStore#acquireLock(io.openmg.kuaz.storage.StaticBuffer, io.openmg.kuaz.storage.StaticBuffer, io.openmg.kuaz.storage.StaticBuffer, StoreTransaction)}
     *
     */
     ...
     * is provided as a meta-data annotation on the {@link io.openmg.kuaz.storage.Entry}, the entry will
     * disappear from the storage backend after the given amount of time. See references to
     * {@link io.openmg.kuaz.storage.EntryMetaData#TTL} for example usage in Titan internals.
     ...
     * by {@link io.openmg.kuaz.storage.StoreMetaData#TTL}.  This is the coarser-grained of the two
     * TTL modes.
     *
