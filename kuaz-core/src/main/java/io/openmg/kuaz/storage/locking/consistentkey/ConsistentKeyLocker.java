...
import io.openmg.kuaz.storage.locking.*;
...
public class ConsistentKeyLocker extends AbstractLocker<ConsistentKeyLockStatus> implements Locker {
     ...
     * exception or a {@link io.openmg.kuaz.storage.PermanentBackendException}, then we'll try to
     ...
     *                   {@link io.openmg.kuaz.storage.TemporaryBackendException}
     */
