package io.openmg.kuaz.storage.keycolumnvalue.scan;
...
public interface ScanMetrics {
     ...
     * accepted by {@link #get(io.openmg.kuaz.storage.keycolumnvalue.scan.ScanMetrics.Metric)}
     * and {@link #increment(io.openmg.kuaz.storage.keycolumnvalue.scan.ScanMetrics.Metric)}.
     */
     ...
     * {@link #increment(io.openmg.kuaz.storage.keycolumnvalue.scan.ScanMetrics.Metric)}.
     *
     * @param metric
     * @return
     */
     ...
     * never through {@link #get(io.openmg.kuaz.storage.keycolumnvalue.scan.ScanMetrics.Metric)}.
     *
