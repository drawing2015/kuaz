...
/**
 * Abstract implementation of {@link io.openmg.kuaz.storage.log.Message} which exposes the timestamp, sender, and payload
 * of a message.
 * Particular {@link io.openmg.kuaz.storage.log.Log} implementations can extend this class.
 *
