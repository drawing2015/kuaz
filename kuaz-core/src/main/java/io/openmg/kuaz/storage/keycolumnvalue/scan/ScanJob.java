...
public interface ScanJob extends Cloneable {
     ...
     * @param metrics {@link io.openmg.kuaz.storage.keycolumnvalue.scan.ScanMetrics} for this job
     */
     ...
     * <p>
     * Before calling
     * {@link #process(io.openmg.kuaz.storage.StaticBuffer, java.util.Map, ScanMetrics)},
     ...
     *
     * @return A clone of this {@link io.openmg.kuaz.storage.keycolumnvalue.scan.ScanJob}
     */
