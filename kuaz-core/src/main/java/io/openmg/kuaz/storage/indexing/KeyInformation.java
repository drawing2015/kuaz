package io.openmg.kuaz.storage.indexing;
 ...
 * index when the key is not fixed in the context, e.g. in {@link IndexProvider#mutate(java.util.Map, IndexRetriever, io.openmg.kuaz.storage.BaseTransaction)}
 *
 * <p/>
 *
...
public interface KeyInformation {
    ...
    /**
     * Returns the {@link io.openmg.kuaz.core.Cardinality} for this key.
     * @return
     */
