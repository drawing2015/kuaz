...
public enum StandardIndexProvider {
    LUCENE("io.openmg.io.openmg.kuaz.storage.ignite.storage.lucene.LuceneIndex", "lucene"),
    ELASTICSEARCH("io.openmg.io.openmg.kuaz.storage.ignite.storage.es.ElasticSearchIndex", ImmutableList.of("elasticsearch", "es")),
    SOLR("io.openmg.io.openmg.kuaz.storage.ignite.storage.solr.SolrIndex", "solr");
