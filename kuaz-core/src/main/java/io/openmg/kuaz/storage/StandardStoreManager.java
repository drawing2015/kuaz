...
public enum StandardStoreManager {
    BDB_JE("io.openmg.io.openmg.kuaz.storage.ignite.storage.berkeleyje.BerkeleyJEStoreManager", "berkeleyje"),
    CASSANDRA_THRIFT("io.openmg.io.openmg.kuaz.storage.ignite.storage.cassandra.thrift.CassandraThriftStoreManager", "cassandrathrift"),
    CASSANDRA_ASTYANAX("io.openmg.io.openmg.kuaz.storage.ignite.storage.cassandra.astyanax.AstyanaxStoreManager", ImmutableList.of("cassandra", "astyanax")),
    CASSANDRA_EMBEDDED("io.openmg.io.openmg.kuaz.storage.ignite.storage.cassandra.embedded.CassandraEmbeddedStoreManager", "embeddedcassandra"),
    HBASE("io.openmg.io.openmg.kuaz.storage.ignite.storage.hbase.HBaseStoreManager", "hbase"),
    IN_MEMORY("io.openmg.io.openmg.kuaz.storage.ignite.storage.keycolumnvalue.inmemory.InMemoryStoreManager", "inmemory");
