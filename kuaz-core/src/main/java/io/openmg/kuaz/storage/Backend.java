package io.openmg.kuaz.storage;
...
import io.openmg.kuaz.storage.indexing.*;
import io.openmg.kuaz.storage.keycolumnvalue.*;
import io.openmg.kuaz.storage.keycolumnvalue.cache.CacheTransaction;
import io.openmg.kuaz.storage.keycolumnvalue.cache.ExpirationKCVSCache;
import io.openmg.kuaz.storage.keycolumnvalue.cache.KCVSCache;
import io.openmg.kuaz.storage.keycolumnvalue.cache.NoKCVSCache;
import io.openmg.kuaz.storage.keycolumnvalue.keyvalue.*;
import io.openmg.kuaz.storage.keycolumnvalue.scan.StandardScanner;
import io.openmg.kuaz.storage.locking.Locker;
import io.openmg.kuaz.storage.locking.LockerProvider;
import io.openmg.kuaz.storage.locking.consistentkey.ConsistentKeyLocker;
import io.openmg.kuaz.storage.locking.consistentkey.ExpectedValueCheckingStoreManager;
import io.openmg.kuaz.storage.log.Log;
import io.openmg.kuaz.storage.log.LogManager;
...
import io.openmg.kuaz.storage.util.MetricInstrumentedStoreManager;
...
//    }
    ...
    public static final Map<String,String> REGISTERED_LOG_MANAGERS = new HashMap<String, String>() {{
        put("default","io.openmg.io.openmg.kuaz.storage.ignite.storage.log.kcvs.KCVSLogManager");
    }};
    ...
    private final Function<String, Locker> ASTYANAX_RECIPE_LOCKER_CREATOR = new Function<String, Locker>() {
        ...
        public Locker apply(String lockerName) {
            ...
            String expectedManagerName = "io.openmg.io.openmg.kuaz.storage.ignite.storage.cassandra.astyanax.AstyanaxStoreManager";
    ...
    private final Function<String, Locker> TEST_LOCKER_CREATOR = new Function<String, Locker>() {
        ...
        @Override
        public Locker apply(String lockerName) {
            return openManagedLocker("io.openmg.io.openmg.kuaz.storage.ignite.storage.util.TestLockerManager",lockerName);
