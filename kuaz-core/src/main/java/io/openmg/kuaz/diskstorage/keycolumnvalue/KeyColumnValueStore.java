...
public interface KeyColumnValueStore {
     ...
     * @throws io.openmg.kuaz.diskstorage.BackendException when columnEnd < columnStart
     * @see KeySliceQuery
     */
     ...
     * @throws io.openmg.kuaz.diskstorage.locking.PermanentLockingException if locking is supported by the implementation and at least
     ...
     * required to, throw {@link io.openmg.kuaz.diskstorage.locking.PermanentLockingException}.
     ...
     * @throws io.openmg.kuaz.diskstorage.locking.PermanentLockingException
