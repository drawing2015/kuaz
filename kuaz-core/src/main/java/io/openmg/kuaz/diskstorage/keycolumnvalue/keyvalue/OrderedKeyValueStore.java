...
public interface OrderedKeyValueStore extends KeyValueStore {
    ...
    /**
     * Like {@link #getSlice(KVQuery, io.openmg.kuaz.diskstorage.keycolumnvalue.StoreTransaction)} but executes
     ...
     * {@link io.openmg.kuaz.diskstorage.keycolumnvalue.StoreFeatures#hasMultiQuery()} return true. Otherwise
