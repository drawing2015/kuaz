...
public enum StandardStoreManager {
    BDB_JE("io.openmg.kuaz.diskstorage.berkeleyje.BerkeleyJEStoreManager", "berkeleyje"),
    CASSANDRA_THRIFT("io.openmg.kuaz.diskstorage.cassandra.thrift.CassandraThriftStoreManager", "cassandrathrift"),
    CASSANDRA_ASTYANAX("io.openmg.kuaz.diskstorage.cassandra.astyanax.AstyanaxStoreManager", ImmutableList.of("cassandra", "astyanax")),
    CASSANDRA_EMBEDDED("io.openmg.kuaz.diskstorage.cassandra.embedded.CassandraEmbeddedStoreManager", "embeddedcassandra"),
    HBASE("io.openmg.kuaz.diskstorage.hbase.HBaseStoreManager", "hbase"),
    IN_MEMORY("io.openmg.kuaz.diskstorage.keycolumnvalue.inmemory.InMemoryStoreManager", "inmemory");
