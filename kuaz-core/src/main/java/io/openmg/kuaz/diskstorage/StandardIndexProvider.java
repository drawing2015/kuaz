...
public enum StandardIndexProvider {
    LUCENE("io.openmg.kuaz.diskstorage.lucene.LuceneIndex", "lucene"),
    ELASTICSEARCH("io.openmg.kuaz.diskstorage.es.ElasticSearchIndex", ImmutableList.of("elasticsearch", "es")),
    SOLR("io.openmg.kuaz.diskstorage.solr.SolrIndex", "solr");
