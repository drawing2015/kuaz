package io.openmg.kuaz.diskstorage.idmanagement;
...
import io.openmg.kuaz.graphdb.database.idassigner.IDBlockSizer;

import java.time.Duration;

import static io.openmg.kuaz.graphdb.configuration.GraphDatabaseConfiguration.UNIQUE_INSTANCE_ID;
