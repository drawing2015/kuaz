...
import io.openmg.kuaz.core.TitanConfigurationException;
import io.openmg.kuaz.core.TitanException;
import io.openmg.kuaz.core.TitanFactory;
...
import io.openmg.kuaz.diskstorage.indexing.*;
import io.openmg.kuaz.diskstorage.keycolumnvalue.*;
import io.openmg.kuaz.diskstorage.keycolumnvalue.cache.CacheTransaction;
import io.openmg.kuaz.diskstorage.keycolumnvalue.cache.ExpirationKCVSCache;
import io.openmg.kuaz.diskstorage.keycolumnvalue.cache.KCVSCache;
import io.openmg.kuaz.diskstorage.keycolumnvalue.cache.NoKCVSCache;
import io.openmg.kuaz.diskstorage.keycolumnvalue.keyvalue.*;
import io.openmg.kuaz.diskstorage.keycolumnvalue.scan.StandardScanner;
import io.openmg.kuaz.diskstorage.locking.Locker;
import io.openmg.kuaz.diskstorage.locking.LockerProvider;
import io.openmg.kuaz.diskstorage.locking.consistentkey.ConsistentKeyLocker;
import io.openmg.kuaz.diskstorage.locking.consistentkey.ExpectedValueCheckingStoreManager;
import io.openmg.kuaz.diskstorage.log.Log;
import io.openmg.kuaz.diskstorage.log.LogManager;
...
import io.openmg.kuaz.diskstorage.util.MetricInstrumentedStore;
import io.openmg.kuaz.diskstorage.configuration.backend.KCVSConfiguration;
import io.openmg.kuaz.diskstorage.util.MetricInstrumentedStoreManager;
...
import io.openmg.kuaz.util.system.ConfigurationUtil;
...
//    }
    ...
    public static final Map<String,String> REGISTERED_LOG_MANAGERS = new HashMap<String, String>() {{
        put("default","io.openmg.kuaz.diskstorage.log.kcvs.KCVSLogManager");
    }};
    ...
    private final Function<String, Locker> ASTYANAX_RECIPE_LOCKER_CREATOR = new Function<String, Locker>() {
        ...
        public Locker apply(String lockerName) {
            ...
            String expectedManagerName = "io.openmg.kuaz.diskstorage.cassandra.astyanax.AstyanaxStoreManager";
    ...
    private final Function<String, Locker> TEST_LOCKER_CREATOR = new Function<String, Locker>() {
        ...
        @Override
        public Locker apply(String lockerName) {
            return openManagedLocker("io.openmg.kuaz.diskstorage.util.TestLockerManager",lockerName);
