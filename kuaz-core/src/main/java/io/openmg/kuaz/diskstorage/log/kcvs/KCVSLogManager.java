...
import io.openmg.kuaz.graphdb.database.idassigner.placement.PartitionIDRange;
import io.openmg.kuaz.graphdb.database.serialize.StandardSerializer;
import io.openmg.kuaz.util.encoding.ConversionHelper;
...
public class KCVSLogManager implements LogManager {
     ...
     * {@link io.openmg.kuaz.graphdb.configuration.GraphDatabaseConfiguration#CLUSTER_MAX_PARTITIONS} and dividing
