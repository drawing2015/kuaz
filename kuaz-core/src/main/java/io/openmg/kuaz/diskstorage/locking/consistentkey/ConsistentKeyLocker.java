...
import io.openmg.kuaz.diskstorage.locking.*;
...
public class ConsistentKeyLocker extends AbstractLocker<ConsistentKeyLockStatus> implements Locker {
     ...
     * exception or a {@link io.openmg.kuaz.diskstorage.PermanentBackendException}, then we'll try to
     ...
     *                   {@link io.openmg.kuaz.diskstorage.TemporaryBackendException}
     */
