...
public interface ScanJob extends Cloneable {
     ...
     * @param metrics {@link io.openmg.kuaz.diskstorage.keycolumnvalue.scan.ScanMetrics} for this job
     */
     ...
     * <p>
     * Before calling
     * {@link #process(io.openmg.kuaz.diskstorage.StaticBuffer, java.util.Map, ScanMetrics)},
     ...
     *
     * @return A clone of this {@link io.openmg.kuaz.diskstorage.keycolumnvalue.scan.ScanJob}
     */
