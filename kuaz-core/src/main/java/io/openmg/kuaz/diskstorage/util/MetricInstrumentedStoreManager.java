...
import static io.openmg.kuaz.diskstorage.util.MetricInstrumentedStore.*;

import java.util.List;
import java.util.Map;

import static io.openmg.kuaz.graphdb.configuration.GraphDatabaseConfiguration.METRICS_MERGE_STORES;
