package io.openmg.kuaz.diskstorage.log.util;
 ...
 * are being added to the {@link io.openmg.kuaz.diskstorage.log.Log} via {@link io.openmg.kuaz.diskstorage.log.Log#add(io.openmg.kuaz.diskstorage.StaticBuffer)}.
 *
 * This class can be used by {@link io.openmg.kuaz.diskstorage.log.Log} implementations to wrap messages.
 *
...
public class FutureMessage<M extends Message> extends AbstractFuture<Message> {
    ...
    /**
     * This method should be called by {@link io.openmg.kuaz.diskstorage.log.Log} implementations when the message was successfully
     * added to the log.
     */
