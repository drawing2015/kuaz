package io.openmg.trike.example;
...
public class GraphOfTheGodsFactory {
     ...
     * {@link #load(io.openmg.trike.core.TitanGraph)} on the opened graph,
     * then calls {@link io.openmg.trike.core.TitanGraph#close()}
     * and returns.
     * <p/>
     ...
     * or {@link #load(io.openmg.trike.core.TitanGraph)}) when calling from
