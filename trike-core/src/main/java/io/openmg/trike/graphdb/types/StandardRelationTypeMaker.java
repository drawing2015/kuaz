...
import io.openmg.trike.core.schema.RelationTypeMaker;
...
public abstract class StandardRelationTypeMaker implements RelationTypeMaker {
     ...
     * time interval using {@link io.openmg.trike.core.TitanVertexQuery#interval(io.openmg.trike.core.PropertyKey, Comparable, Comparable)}.
     * <br />
     ...
     * in the given order.
     * <p/>
     * {@link io.openmg.trike.core.RelationType}s used in the sort key must be either property out-unique keys or out-unique unidirected edge lables.
     *
    ...
    /**
     * Defines in which order to sort the relations for efficient retrieval, i.e. either increasing ({@link io.openmg.trike.graphdb.internal.Order#ASC}) or
     * decreasing ({@link io.openmg.trike.graphdb.internal.Order#DESC}).
     *
