package io.openmg.trike.graphdb.query.graph;

import com.google.common.base.Preconditions;
import io.openmg.trike.core.TitanElement;
import io.openmg.trike.graphdb.internal.ElementCategory;
import io.openmg.trike.graphdb.internal.OrderList;
import io.openmg.trike.graphdb.query.BackendQueryHolder;
import io.openmg.trike.graphdb.query.BaseQuery;
import io.openmg.trike.graphdb.query.ElementQuery;
import io.openmg.trike.graphdb.query.QueryUtil;
import io.openmg.trike.graphdb.query.condition.Condition;
import io.openmg.trike.graphdb.query.condition.FixedCondition;
import io.openmg.trike.graphdb.query.profile.ProfileObservable;
...
/**
 * An executable {@link ElementQuery} for {@link io.openmg.trike.core.TitanGraphQuery}. This query contains
 * the condition, and only one sub-query {@link JointIndexQuery}.
 * It also maintains the ordering for the query result which is needed by the {@link io.openmg.trike.graphdb.query.QueryProcessor}
