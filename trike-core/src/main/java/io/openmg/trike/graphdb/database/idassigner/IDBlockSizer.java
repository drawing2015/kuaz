...
public interface IDBlockSizer {
    ...
    /**
     * The size of the id block to be returned by calls {@link io.openmg.trike.diskstorage.IDAuthority#getIDBlock(int,int, Duration)}
    ...
    /**
     * Returns the upper bound for any id block returned by {@link io.openmg.trike.diskstorage.IDAuthority#getIDBlock(int,int, Duration)}
     * for the given id namespace.
