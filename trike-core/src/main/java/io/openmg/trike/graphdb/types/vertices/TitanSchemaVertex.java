...
import io.openmg.trike.core.TitanVertexQuery;
import io.openmg.trike.core.schema.SchemaStatus;
import io.openmg.trike.graphdb.internal.TitanSchemaCategory;
import io.openmg.trike.graphdb.transaction.RelationConstructor;
import io.openmg.trike.graphdb.transaction.StandardTitanTx;
import io.openmg.trike.graphdb.types.*;
import io.openmg.trike.graphdb.types.indextype.CompositeIndexTypeWrapper;
import io.openmg.trike.graphdb.types.indextype.MixedIndexTypeWrapper;
...
public class TitanSchemaVertex extends CacheVertex implements SchemaSource {
     ...
     * This is needed when the type gets modified in the {@link io.openmg.trike.graphdb.database.management.ManagementSystem}.
     */
