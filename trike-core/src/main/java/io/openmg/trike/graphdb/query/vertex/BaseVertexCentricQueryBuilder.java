...
import io.openmg.trike.core.BaseVertexQuery;
...
import io.openmg.trike.graphdb.internal.RelationCategory;
import io.openmg.trike.graphdb.query.Query;
import io.openmg.trike.graphdb.query.TitanPredicate;
import io.openmg.trike.graphdb.query.condition.PredicateCondition;
import io.openmg.trike.graphdb.relations.RelationIdentifier;
import io.openmg.trike.graphdb.tinkerpop.ElementUtils;
...
/**
 * Builds a {@link io.openmg.trike.core.BaseVertexQuery}, optimizes the query and compiles the result into a {@link BaseVertexCentricQuery} which
...
public abstract class BaseVertexCentricQueryBuilder<Q extends BaseVertexQuery<Q>> implements BaseVertexQuery<Q> {
    ...
    /**
     * Whether this query is asking for the value of an {@link io.openmg.trike.graphdb.types.system.ImplicitKey}.
     * </p>
