...
import io.openmg.trike.graphdb.query.QueryProcessor;
 ...
 * {@link #constructQuery(io.openmg.trike.graphdb.internal.RelationCategory)}. However, there is
 * one important special case: If the constructed query is simple (i.e. {@link io.openmg.trike.graphdb.query.vertex.VertexCentricQuery#isSimple()=true}
 ...
 * {@link io.openmg.trike.graphdb.database.IndexSerializer}) via {@link #queryOnlyLoaded()}.
 * </p>
