...
import io.openmg.trike.diskstorage.util.Hex;
import io.openmg.trike.graphdb.olap.computer.FulgoraGraphComputer;
import io.openmg.trike.graphdb.relations.RelationIdentifier;
import io.openmg.trike.graphdb.types.system.BaseVertexLabel;
...
public abstract class TitanBlueprintsTransaction implements TitanTransaction {
     ...
     * <p/>
     * Custom id setting must be enabled via the configuration option {@link io.openmg.trike.graphdb.configuration.GraphDatabaseConfiguration#ALLOW_SETTING_VERTEX_ID}.
     * <p/>
     * Use {@link io.openmg.trike.core.util.TitanId#toVertexId(long)} to construct a valid Titan vertex id from a user id.
     *
...
//        }
        io.openmg.trike.graphdb.util.ElementHelper.attachProperties(vertex, keyValues);
        return vertex;
    }
