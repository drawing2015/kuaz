 ...
 * {@link #execute(io.openmg.trike.graphdb.internal.RelationCategory, BasicVertexCentricQueryBuilder.ResultConstructor)}.
 * </p>
...
public class MultiVertexCentricQueryBuilder extends BasicVertexCentricQueryBuilder<MultiVertexCentricQueryBuilder> implements TitanMultiVertexQuery<MultiVertexCentricQueryBuilder> {
    ...
    /**
     * Constructs the BaseVertexCentricQuery through {@link BasicVertexCentricQueryBuilder#constructQuery(io.openmg.trike.graphdb.internal.RelationCategory)}.
     ...
     * pre-load the return result sets into the associated {@link io.openmg.trike.graphdb.vertices.CacheVertex} or
