package io.openmg.trike.graphdb.configuration;
...
import io.openmg.trike.diskstorage.StandardIndexProvider;
import io.openmg.trike.diskstorage.StandardStoreManager;
import io.openmg.trike.diskstorage.keycolumnvalue.ttl.TTLKCVSManager;
import io.openmg.trike.graphdb.tinkerpop.TitanDefaultSchemaMaker;
import io.openmg.trike.graphdb.tinkerpop.Tp3DefaultSchemaMaker;
import io.openmg.trike.graphdb.database.management.ManagementSystem;
import io.openmg.trike.graphdb.types.typemaker.DisableDefaultSchemaMaker;
import io.openmg.trike.util.stats.NumberUtil;
import io.openmg.trike.diskstorage.util.time.*;
import io.openmg.trike.diskstorage.configuration.*;
import io.openmg.trike.diskstorage.configuration.backend.CommonsConfiguration;
import io.openmg.trike.diskstorage.configuration.backend.KCVSConfiguration;
import io.openmg.trike.diskstorage.idmanagement.ConflictAvoidanceMode;
import io.openmg.trike.diskstorage.idmanagement.ConsistentKeyIDAuthority;
import io.openmg.trike.diskstorage.keycolumnvalue.KeyColumnValueStoreManager;
import io.openmg.trike.diskstorage.keycolumnvalue.StoreFeatures;
import io.openmg.trike.diskstorage.log.kcvs.KCVSLog;
import io.openmg.trike.diskstorage.log.kcvs.KCVSLogManager;
import io.openmg.trike.graphdb.database.cache.MetricInstrumentedSchemaCache;
import io.openmg.trike.graphdb.database.cache.StandardSchemaCache;
import io.openmg.trike.graphdb.database.cache.SchemaCache;
import io.openmg.trike.graphdb.database.serialize.StandardSerializer;
import io.openmg.trike.util.encoding.LongEncoding;
import io.openmg.trike.util.system.ConfigurationUtil;
import io.openmg.trike.util.system.NetworkUtil;
...
import io.openmg.trike.graphdb.database.idassigner.VertexIDAssigner;
import io.openmg.trike.graphdb.database.serialize.Serializer;
import io.openmg.trike.graphdb.transaction.StandardTransactionBuilder;
import io.openmg.trike.util.stats.MetricManager;

/**
 * Provides functionality to configure a {@link io.openmg.trike.core.TitanGraph} INSTANCE.
 * <p/>
 * <p/>
...
//    public static final long LOCK_EXPIRE_MS_DEFAULT = 300 * 1000;
    ...
    /**
     * Locker type to use.  The supported types are in {@link io.openmg.trike.diskstorage.Backend}.
     */
...
//    public static final long IDAUTHORITY_WAIT_MS_DEFAULT = 300;
    ...
    /**
     * When Titan allocates IDs with {@link io.openmg.trike.diskstorage.idmanagement.ConflictAvoidanceMode#GLOBAL_AUTO}
     ...
     * {@link io.openmg.trike.diskstorage.idmanagement.ConflictAvoidanceMode#GLOBAL_AUTO}.
     */
...
//    public static final int IDAUTHORITY_RETRY_COUNT_DEFAULT = 20;
     ...
     * {@link io.openmg.trike.diskstorage.idmanagement.ConflictAvoidanceMode#NONE}. However, note that while the
     ...
     *
     * This setting has no effect when {@link #IDAUTHORITY_CONFLICT_AVOIDANCE} is configured to
     * {@link io.openmg.trike.diskstorage.idmanagement.ConflictAvoidanceMode#NONE}.
     */
...
//    public static final boolean BASIC_METRICS_DEFAULT = false;
     ...
     */
    public static final String METRICS_PREFIX_DEFAULT = "io.openmg.trike";
...
//    public static final String GRAPHITE_PREFIX_DEFAULT = null;
    ...
    public static final ConfigOption<String> GREMLIN_GRAPH = new ConfigOption<String>(GREMLIN_NS, "graph",
            "The implementation of graph factory that will be used by gremlin server", ConfigOption.Type.LOCAL, "io.openmg.trike.core.TitanFactory");
