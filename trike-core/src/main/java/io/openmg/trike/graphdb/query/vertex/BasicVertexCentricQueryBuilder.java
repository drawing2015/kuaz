package io.openmg.trike.graphdb.query.vertex;
...
import io.openmg.trike.util.datastructures.Interval;
import io.openmg.trike.util.datastructures.PointInterval;
import io.openmg.trike.util.datastructures.RangeInterval;
...
/**
 * Builds a {@link BaseVertexQuery}, optimizes the query and compiles the result into a {@link io.openmg.trike.graphdb.query.vertex.BaseVertexCentricQuery} which
...
public abstract class BasicVertexCentricQueryBuilder<Q extends BaseVertexQuery<Q>> extends BaseVertexCentricQueryBuilder<Q> {
     ...
     * vertex object only. This is used in combination with {@link io.openmg.trike.graphdb.vertices.PreloadedVertex}, for example.
     */
    ...
    /**
     * If {@link #isImplicitKeyQuery(io.openmg.trike.graphdb.internal.RelationCategory)} is true,
     ...
     * logic is taken from {@link #constructQuery(io.openmg.trike.graphdb.internal.RelationCategory)}
     ...
     * @param baseQuery as constructed by {@link #constructQuery(io.openmg.trike.graphdb.internal.RelationCategory)}
     * @return
     */
     ...
     * to adjust the limit too often in {@link io.openmg.trike.graphdb.query.LimitAdjustingIterator}.
     *
