package io.openmg.trike.graphdb.database.log;
...
public class TransactionLogHeader {
    ...
    private static void logRelations(DataOutput out, final Collection<InternalRelation> relations, StandardTitanTx tx) {
        ...
        for (InternalRelation rel : relations) {
            ...
            io.openmg.trike.diskstorage.Entry entry = tx.getEdgeSerializer().writeRelation(rel, 0, tx);
    ...
    public static class Entry {
        ...
        private static Collection<Modification> readModifications(Change state, ReadBuffer in, Serializer serializer) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                io.openmg.trike.diskstorage.Entry entry = BufferUtil.readEntry(in,serializer);
    ...
    public static class Modification {
        ...
        public final io.openmg.trike.diskstorage.Entry relationEntry;

        private Modification(Change state, long outVertexId, io.openmg.trike.diskstorage.Entry relationEntry) {
            this.state = state;
