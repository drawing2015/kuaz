...
import io.openmg.trike.graphdb.query.graph.MultiKeySliceQuery;
...
import io.openmg.trike.diskstorage.util.BufferUtil;
import io.openmg.trike.diskstorage.util.HashingUtil;
import io.openmg.trike.diskstorage.util.StaticArrayEntry;
import io.openmg.trike.graphdb.database.idhandling.VariableLong;
...
import static io.openmg.trike.graphdb.configuration.GraphDatabaseConfiguration.INDEX_NAME_MAPPING;
