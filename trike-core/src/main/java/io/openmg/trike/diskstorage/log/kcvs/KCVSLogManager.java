...
import io.openmg.trike.graphdb.database.idassigner.placement.PartitionIDRange;
import io.openmg.trike.graphdb.database.serialize.StandardSerializer;
import io.openmg.trike.util.encoding.ConversionHelper;
...
public class KCVSLogManager implements LogManager {
     ...
     * {@link io.openmg.trike.graphdb.configuration.GraphDatabaseConfiguration#CLUSTER_MAX_PARTITIONS} and dividing
