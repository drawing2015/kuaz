package io.openmg.trike.diskstorage.keycolumnvalue.scan;
...
public interface ScanMetrics {
     ...
     * accepted by {@link #get(io.openmg.trike.diskstorage.keycolumnvalue.scan.ScanMetrics.Metric)}
     * and {@link #increment(io.openmg.trike.diskstorage.keycolumnvalue.scan.ScanMetrics.Metric)}.
     */
     ...
     * {@link #increment(io.openmg.trike.diskstorage.keycolumnvalue.scan.ScanMetrics.Metric)}.
     *
     * @param metric
     * @return
     */
     ...
     * never through {@link #get(io.openmg.trike.diskstorage.keycolumnvalue.scan.ScanMetrics.Metric)}.
     *
