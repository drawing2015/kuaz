...
public interface ScanJob extends Cloneable {
     ...
     * @param metrics {@link io.openmg.trike.diskstorage.keycolumnvalue.scan.ScanMetrics} for this job
     */
     ...
     * <p>
     * Before calling
     * {@link #process(io.openmg.trike.diskstorage.StaticBuffer, java.util.Map, ScanMetrics)},
     ...
     *
     * @return A clone of this {@link io.openmg.trike.diskstorage.keycolumnvalue.scan.ScanJob}
     */
