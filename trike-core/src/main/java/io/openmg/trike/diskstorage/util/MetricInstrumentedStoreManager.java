...
import static io.openmg.trike.diskstorage.util.MetricInstrumentedStore.*;

import java.util.List;
import java.util.Map;

import static io.openmg.trike.graphdb.configuration.GraphDatabaseConfiguration.METRICS_MERGE_STORES;
