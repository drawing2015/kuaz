...
/**
 * Abstract implementation of {@link io.openmg.trike.diskstorage.log.Message} which exposes the timestamp, sender, and payload
 * of a message.
 * Particular {@link io.openmg.trike.diskstorage.log.Log} implementations can extend this class.
 *
