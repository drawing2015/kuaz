...
import io.openmg.trike.core.TitanConfigurationException;
import io.openmg.trike.core.TitanException;
import io.openmg.trike.core.TitanFactory;
...
import io.openmg.trike.diskstorage.indexing.*;
...
import io.openmg.trike.diskstorage.keycolumnvalue.cache.ExpirationKCVSCache;
import io.openmg.trike.diskstorage.keycolumnvalue.cache.KCVSCache;
import io.openmg.trike.diskstorage.keycolumnvalue.cache.NoKCVSCache;
import io.openmg.trike.diskstorage.keycolumnvalue.keyvalue.*;
import io.openmg.trike.diskstorage.keycolumnvalue.scan.StandardScanner;
import io.openmg.trike.diskstorage.locking.Locker;
import io.openmg.trike.diskstorage.locking.LockerProvider;
import io.openmg.trike.diskstorage.locking.consistentkey.ConsistentKeyLocker;
import io.openmg.trike.diskstorage.locking.consistentkey.ExpectedValueCheckingStoreManager;
import io.openmg.trike.diskstorage.log.Log;
import io.openmg.trike.diskstorage.log.LogManager;
import io.openmg.trike.diskstorage.log.kcvs.KCVSLog;
import io.openmg.trike.diskstorage.log.kcvs.KCVSLogManager;
import io.openmg.trike.diskstorage.util.BackendOperation;
import io.openmg.trike.diskstorage.util.MetricInstrumentedStore;
import io.openmg.trike.diskstorage.configuration.backend.KCVSConfiguration;
import io.openmg.trike.diskstorage.util.MetricInstrumentedStoreManager;
import io.openmg.trike.diskstorage.util.StandardBaseTransactionConfig;
...
import io.openmg.trike.graphdb.configuration.TitanConstants;
...
//    }
    ...
    public static final Map<String,String> REGISTERED_LOG_MANAGERS = new HashMap<String, String>() {{
        put("default","io.openmg.trike.diskstorage.log.kcvs.KCVSLogManager");
    }};
    ...
    private final Function<String, Locker> ASTYANAX_RECIPE_LOCKER_CREATOR = new Function<String, Locker>() {
        ...
        public Locker apply(String lockerName) {
            ...
            String expectedManagerName = "io.openmg.trike.diskstorage.cassandra.astyanax.AstyanaxStoreManager";
    ...
    private final Function<String, Locker> TEST_LOCKER_CREATOR = new Function<String, Locker>() {
        ...
        @Override
        public Locker apply(String lockerName) {
            return openManagedLocker("io.openmg.trike.diskstorage.util.TestLockerManager",lockerName);
