...
public interface KeyColumnValueStore {
     ...
     * @throws io.openmg.trike.diskstorage.BackendException when columnEnd < columnStart
     * @see KeySliceQuery
     */
     ...
     * @throws io.openmg.trike.diskstorage.locking.PermanentLockingException if locking is supported by the implementation and at least
     ...
     * required to, throw {@link io.openmg.trike.diskstorage.locking.PermanentLockingException}.
     ...
     * @throws io.openmg.trike.diskstorage.locking.PermanentLockingException
