 ...
 * index when the key is not fixed in the context, e.g. in {@link IndexProvider#mutate(java.util.Map, IndexRetriever, io.openmg.trike.diskstorage.BaseTransaction)}
 *
 * <p/>
 *
...
public interface KeyInformation {
    ...
    /**
     * Returns the {@link io.openmg.trike.core.Cardinality} for this key.
     * @return
     */
