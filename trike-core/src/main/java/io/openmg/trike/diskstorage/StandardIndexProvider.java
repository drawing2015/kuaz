...
public enum StandardIndexProvider {
    LUCENE("io.openmg.trike.diskstorage.lucene.LuceneIndex", "lucene"),
    ELASTICSEARCH("io.openmg.trike.diskstorage.es.ElasticSearchIndex", ImmutableList.of("elasticsearch", "es")),
    SOLR("io.openmg.trike.diskstorage.solr.SolrIndex", "solr");
