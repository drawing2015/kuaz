...
public interface StoreFeatures {
     ...
     * {@link KeyColumnValueStore#acquireLock(io.openmg.trike.diskstorage.StaticBuffer, io.openmg.trike.diskstorage.StaticBuffer, io.openmg.trike.diskstorage.StaticBuffer, StoreTransaction)}
     *
     */
     ...
     * is provided as a meta-data annotation on the {@link io.openmg.trike.diskstorage.Entry}, the entry will
     * disappear from the storage backend after the given amount of time. See references to
     * {@link io.openmg.trike.diskstorage.EntryMetaData#TTL} for example usage in Titan internals.
     ...
     * by {@link io.openmg.trike.diskstorage.StoreMetaData#TTL}.  This is the coarser-grained of the two
     * TTL modes.
     *
