...
import io.openmg.trike.diskstorage.locking.*;
...
public class ConsistentKeyLocker extends AbstractLocker<ConsistentKeyLockStatus> implements Locker {
     ...
     * exception or a {@link io.openmg.trike.diskstorage.PermanentBackendException}, then we'll try to
     ...
     *                   {@link io.openmg.trike.diskstorage.TemporaryBackendException}
     */
