...
public class ManagementUtil {
     ...
     *
     * This is a utility method to be invoked between two {@link io.openmg.trike.core.schema.TitanManagement#updateIndex(TitanIndex, io.openmg.trike.core.schema.SchemaAction)} calls
