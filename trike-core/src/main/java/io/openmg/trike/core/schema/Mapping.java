 ...
 * {@link TitanManagement#addIndexKey(TitanGraphIndex, io.openmg.trike.core.PropertyKey, Parameter[])}.
 * <p/>
...
public enum Mapping {
    ...
    /**
     * Returns the mapping as a parameter so that it can be passed to {@link TitanManagement#addIndexKey(TitanGraphIndex, io.openmg.trike.core.PropertyKey, Parameter[])}
     * @return
     */
