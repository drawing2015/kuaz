...
/**
 * RelationTypeMaker is a factory for {@link io.openmg.trike.core.RelationType}s. RelationType can be configured to provide data verification,
 * better storage efficiency, and higher performance. The RelationType defines the schema for all {@link io.openmg.trike.core.TitanRelation}s
 * of that type.
 * <p/>
 * There are two kinds of RelationTypes: {@link io.openmg.trike.core.EdgeLabel} and {@link io.openmg.trike.core.PropertyKey} which
 ...
 * @see io.openmg.trike.core.RelationType
 */
