...
import io.openmg.trike.core.schema.SchemaManager;
...
/**
 * TitanGraphTransaction defines a transactional context for a {@link io.openmg.trike.core.TitanGraph}. Since TitanGraph is a transactional graph
...
public interface TitanGraphTransaction extends Graph, SchemaManager {
    ...
    */
    ...
    /**
     * Returns a {@link io.openmg.trike.core.TitanIndexQuery} to query for vertices or edges against the specified indexing backend using
    ...
    /**
     * @return
     * @see TitanGraph#multiQuery(io.openmg.trike.core.TitanVertex...)
     */
    @Deprecated
