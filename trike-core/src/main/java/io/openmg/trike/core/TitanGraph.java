...
@Graph.OptIn("io.openmg.trike.blueprints.process.traversal.strategy.TitanStrategySuite")
//------------------------
@Graph.OptOut(
...
public interface TitanGraph extends TitanGraphTransaction {
    ...
    */
     ...
     * <p/>
     * The transaction is open when it is returned but MUST be explicitly closed by calling {@link io.openmg.trike.core.TitanTransaction#commit()}
     * or {@link io.openmg.trike.core.TitanTransaction#rollback()} when it is no longer needed.
     * <p/>
