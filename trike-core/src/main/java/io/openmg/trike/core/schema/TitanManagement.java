...
import io.openmg.trike.core.TitanTransaction;
 ...
 * A TitanManagement transaction is opened on a graph via {@link io.openmg.trike.core.TitanGraph#openManagement()}.
 * <p/>
...
public interface TitanManagement extends TitanConfiguration, SchemaManager {
    ...
    /**
     * Identical to {@link #buildEdgeIndex(io.openmg.trike.core.EdgeLabel, String, com.tinkerpop.gremlin.structure.Direction, com.tinkerpop.gremlin.structure.Order, io.openmg.trike.core.PropertyKey...)}
    ...
    /**
     * Identical to {@link #buildPropertyIndex(io.openmg.trike.core.PropertyKey, String, com.tinkerpop.gremlin.structure.Order, io.openmg.trike.core.PropertyKey...)}
     ...
     * {@link io.openmg.trike.core.schema.SchemaAction#REINDEX} or {@link io.openmg.trike.core.schema.SchemaAction#REMOVE_INDEX}
     ...
     *
     * @see io.openmg.trike.core.TitanTransaction#commit()
     */
    public void commit();
     ...
     *
     * @see io.openmg.trike.core.TitanTransaction#rollback()
     */
