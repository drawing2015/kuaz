package io.openmg.trike.core;

import com.google.common.base.Preconditions;
import com.google.common.base.Predicate;
import com.google.common.collect.Iterators;

import io.openmg.trike.core.log.LogProcessorFramework;
import io.openmg.trike.core.log.TransactionRecovery;
...
import io.openmg.trike.graphdb.log.StandardLogProcessorFramework;
import io.openmg.trike.graphdb.log.StandardTransactionLogProcessor;
...
public class TitanFactory {
     ...
     * the graph can be opened with {@link io.openmg.trike.core.TitanFactory.Builder#open()}.
     *
     * @return
     */
    ...
    /**
     * Returns a {@link io.openmg.trike.core.log.LogProcessorFramework} for processing transaction log entries
