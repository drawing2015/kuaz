package io.openmg.trike.core.util;
...
public enum ReflectiveConfigOptionLoader {
    ...
    public void loadStandard(Class<?> caller) {
        ...
        List<String> classnames = ImmutableList.of(
            "io.openmg.trike.diskstorage.hbase.HBaseStoreManager",
            "io.openmg.trike.diskstorage.cassandra.astyanax.AstyanaxStoreManager",
            "io.openmg.trike.diskstorage.cassandra.AbstractCassandraStoreManager",
            "io.openmg.trike.diskstorage.cassandra.thrift.CassandraThriftStoreManager",
            "io.openmg.trike.diskstorage.es.ElasticSearchIndex",
            "io.openmg.trike.diskstorage.solr.SolrIndex",
            "io.openmg.trike.diskstorage.log.kcvs.KCVSLog",
            "io.openmg.trike.diskstorage.log.kcvs.KCVSLogManager",
            "io.openmg.trike.graphdb.configuration.GraphDatabaseConfiguration",
            "io.openmg.trike.graphdb.database.idassigner.placement.SimpleBulkPlacementStrategy",
            "io.openmg.trike.graphdb.database.idassigner.VertexIDAssigner",
            //"io.openmg.trike.graphdb.TestMockIndexProvider",
            //"io.openmg.trike.graphdb.TestMockLog",
            "io.openmg.trike.diskstorage.berkeleyje.BerkeleyJEStoreManager");
